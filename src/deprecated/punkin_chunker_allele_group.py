# This file contains code for the old style of punkin-chunker.  
# I'm sorting by Allele group
# I probably am not using this code either.
...
def BlastMinionReadsAgainstAPDRef(inputFilename, outputDirectory, HLAReferenceFilename):
